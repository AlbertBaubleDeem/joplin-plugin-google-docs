...
const repoRoot = path.resolve(rootDir, '..'); // manifest screenshot/icon paths are relative to repo root (for joplinapp.org)
...
function validateScreenshots(screenshots) {
	...
	for (const screenshot of screenshots) {
		...
		const screenshotPath = path.resolve(repoRoot, screenshot.src);
